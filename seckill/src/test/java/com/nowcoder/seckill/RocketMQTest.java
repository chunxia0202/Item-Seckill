...
public class RocketMQTest {
    ...
    public static void main(String[] args) throws Exception {
        testDefaultMQProducer();//模拟生产者发送消息
        testDefaultMQConsumer();//模拟消费者消费消息，这是最简单的生产者消费者模型
//        testTransactionMQProducer();
    ...
    public static void testDefaultMQProducer() throws Exception {
        ...
        producer.setNamesrvAddr("114.55.244.240:9876");
        producer.start();
